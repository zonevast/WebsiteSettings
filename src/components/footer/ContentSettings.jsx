...
const ContentSettings = ({ settings, updateSettings }) => {
  const t = useTranslations("FooterSettingsPage.contentSettings");
  ...
  const handleRemoveColumn = (columnId) => {
    const updatedColumns = settings.columns.filter(
                  ...
                  <div className="p-4 border border-default-200 rounded-lg mb-4">
                    ...
                    <div className="flex justify-end gap-2">
                      <Button
                        variant="flat"
                        onPress={() =>
                          setNewColumn({ title: undefined, links: [] })
                        }
                      >
                        {t("cancel")}
                      </Button>
                ...
                {editingColumn && (
                  <div className="p-4 border border-default-200 rounded-lg mb-4">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button color="primary" onPress={handleUpdateColumn}>
                        {t("update")}
                      </Button>
                    </div>
                  </div>
                      ...
                      title={
                        <div className="flex items-center justify-between w-full">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <Tooltip
                              content={column.isVisible ? t("hide") : t("show")}
                            >
                              <Button
                                isIconOnly
                                size="sm"
                                variant="light"
                                onPress={() =>
                                  handleToggleColumnVisibility(column.id)
                                }
                              >
                                {column.isVisible ? (
                                  <Eye size={16} />
                                    ...
                                    <div className="flex items-center gap-1">
                                      ...
                                      <Tooltip content={t("delete")}>
                                        <Button
                                          ...
                                          color="danger"
                                          onPress={() =>
                                            handleRemoveLink(column.id, link.id)
                                          }
                                        >
                                          <Trash2 size={14} />
                                        </Button>
          ...
          <Card>
            <CardBody className="space-y-4">
              <div className="flex items-start gap-3">
                <Copyright
                  size={20}
                  className="text-default-500 mt-1 flex-shrink-0"
                />
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-grow">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateSettings({ additionalText: e.target.value })
                    }
                    minRows={2}
                    maxRows={4}
                  />
