                  ...
                  <Card key={index} className="p-3">
                    <CardBody className="space-y-3">
                      <div className="flex justify-between items-center">
                        <h5 className="text-sm font-medium">{t("button")} {index + 1}</h5>
                        <Button
                          isIconOnly
                          size="sm"
                          color="danger"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Select
                          label={t("buttonSize")}
                          value={button.size}
                          onChange={(e) => handleButtonChange(index, "size", e.target.value)}
                          size="sm"
                        >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onChange={(e) => handleButtonChange(index, "openInNewTab", e.target.checked)}
                          size="sm"
                        />
                      </div>
                    </CardBody>
          ...
          <Card className="mt-4">
            <CardBody className="space-y-4">
              ...
              >
                ...
                <SelectItem key="minimal" value="minimal">{t("minimal")}</SelectItem>
                <SelectItem key="video" value="video">{t("videoBackground")}</SelectItem>
              </Select>
            ...
            <CardBody className="space-y-4">
              ...
              {settings.animation.enabled && (
                ...
                >
                  ...
                  <SelectItem key="slideLeft" value="slideLeft">{t("slideLeft")}</SelectItem>
                  <SelectItem key="slideRight" value="slideRight">{t("slideRight")}</SelectItem>
