  ...
  const renderHeroSection = () => {
    ...
    if (hero.style === "split") {
      ...
      contentStyle.textAlign =
        device === "mobile" ? hero.contentAlignment : "left";
    }
      ...
      <div style={heroStyle}>
        ...
        <div style={contentStyle}>
          <motion.div
            ...
            animate="visible"
            variants={
              hero.animation.enabled && hero.animation.type === "fade"
                ? fadeIn
                : hero.animation.enabled && hero.animation.type === "slideUp"
                ? slideUp
                : hero.animation.enabled && hero.animation.type === "slideLeft"
                ? slideIn
                : {}
            }
          >
              ...
              variants={
                hero.animation.enabled && hero.animation.type === "fade"
                  ...
                  : hero.animation.enabled &&
                    hero.animation.type === "slideRight"
                  ? {
                      hidden: { opacity: 0, x: 50 },
                      visible: {
                        opacity: 1,
  ...
  const renderFeaturesSection = () => {
    ...
    const gridStyle = {
      ...
      gridTemplateColumns:
        device === "mobile"
          ? "1fr"
          : device === "tablet" && features.columns > 2
          ? "repeat(2, 1fr)"
    ...
    const featureStyle = {
      ...
      borderRadius: "8px",
      backgroundColor:
        features.featureStyle === "simple"
          ? "transparent"
          : features.featureStyle === "bordered"
          ? "transparent"
          : "#fff",
      border:
        features.featureStyle === "bordered" ? "1px solid #eaeaea" : "none",
      boxShadow:
        features.featureStyle === "shadowed" ||
        features.featureStyle === "elevated"
          ? "0 4px 14px 0 rgba(0, 0, 0, 0.1)"
          : "none",
      transform:
        features.featureStyle === "elevated" ? "translateY(0)" : "none",
      ...
      <div style={sectionStyle}>
        ...
        >
          {contentBlocks.blocks.map((block, index) => {
            ...
            const isAlternating =
              contentBlocks.layout === "alternating" ||
              contentBlocks.layout === "zigzag";
            ...
            const blockStyle = {
              ...
              borderRadius:
                contentBlocks.blockStyle === "rounded" ? "12px" : "0",
              overflow: "hidden",
              border:
                contentBlocks.blockStyle === "bordered"
                  ? "1px solid #eaeaea"
                  : "none",
              boxShadow:
                contentBlocks.blockStyle === "shadowed"
                  ? "0 4px 14px 0 rgba(0, 0, 0, 0.1)"
                  : "none",
            ...
            return (
              <motion.div
                ...
                animate="visible"
                variants={
                  contentBlocks.animation.enabled &&
                  contentBlocks.animation.type === "fade"
                    ? fadeIn
                    : contentBlocks.animation.enabled &&
                      contentBlocks.animation.type === "slideUp"
                    ? slideUp
                    : contentBlocks.animation.enabled &&
                      contentBlocks.animation.type === "slideIn"
                    ? slideIn
                    : {}
                }
              >
  ...
  const renderTestimonials = () => {
    ...
    const gridStyle = {
      ...
      gridTemplateColumns:
        device === "mobile"
          ? "1fr"
          : device === "tablet" && testimonials.columns > 2
          ? "repeat(2, 1fr)"
    ...
    const testimonialStyle = {
      ...
      borderRadius: "8px",
      backgroundColor:
        testimonials.testimonialStyle === "simple"
          ? "transparent"
          : testimonials.testimonialStyle === "card"
          ? "#fff"
          : "transparent",
      border:
        testimonials.testimonialStyle === "bordered"
          ? "1px solid #eaeaea"
          : "none",
      boxShadow:
        testimonials.testimonialStyle === "shadowed"
          ? "0 4px 14px 0 rgba(0, 0, 0, 0.1)"
          : "none",
      position: "relative",
    };
        ...
        <div style={gridStyle}>
          {testimonials.items.map((testimonial, index) => (
            <motion.div
              ...
              transition={{ delay: index * 0.1 }}
            >
              {testimonials.testimonialStyle === "quote" &&
                testimonials.showQuotationMarks && (
                  <div
                    style={{
                      position: "absolute",
                      top: "20px",
    ...
    return (
      <div style={sectionStyle}>
        ...
        <motion.div
          ...
          animate="visible"
          variants={
            cta.animation.enabled && cta.animation.type === "fade"
              ? fadeIn
              : cta.animation.enabled && cta.animation.type === "slideUp"
              ? slideUp
        ...
        >
          <div
            style={
              cta.layout === "split" && device !== "mobile" ? { flex: "1" } : {}
            }
          >
            <h2
              style={{
          ...
          {cta.button.text && (
            <div
              style={
                cta.layout === "split" && device !== "mobile"
                  ? { flex: "0 0 auto" }
                  : {}
              }
            >
              <Button
                ...
                startContent={
                  cta.button.icon ? (
                    <span className="material-icons">{cta.button.icon}</span>
                  ) : null
                }
              >
                {cta.button.text}
